...
| <p align="center">`subsro_api_key`</p> | <p align="center">str</p> | | Token de autentificare API Subs.ro (vezi [aici](https://github.com/ReNeGaDe124/Subs.ro-Plex-Subtitle-Downloader?tab=readme-ov-file#-api-token-subsro) cum să îl obții). |
